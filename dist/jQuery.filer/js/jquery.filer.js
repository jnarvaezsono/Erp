...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            ...
            drop: "Suelte el archivo aquí para subir",
            removeConfirmation: "Seguro que desea eliminar este archivo?",
            errors: {
//                filesLimit: "Only {{fi-limit}} files are allowed to be uploaded.",
                filesLimit: "Sólo {{fi-limit}} archivos se les permite ser cargado",
                filesType: "La extencion del archivo no es la adecuada.",
