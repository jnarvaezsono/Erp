                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-sm decimals" id="psrad_desc" name="psrad_desc" value="<?= $row->descuento ?>" placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input type="text" class="form-control input-sm decimals" id="psrad_iva" name="psrad_iva" value="<?= $row->iva ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input type="text" class="form-control input-sm decimals" id="psrad_spa" name="psrad_spa" value="<?= $row->spa ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input readonly type="text" class="form-control input-sm decimals" id="psrad_ivaspa" name="psrad_ivaspa" value="<?= $row->iva_spa ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">$.</span>
                                        <input readonly type="text" class="form-control input-sm decimals" id="psrad_valor" value="<?= $row->valor ?>" placeholder="$ 0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-sm" id="psrad_numorden" name="psrad_numorden" value="<?= $row->orden_cliente ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>No.Cotización</label>
                                                <input type="text" class="form-control input-sm" id="psrad_numcotizacion" name="psrad_numcotizacion" value="<?= $row->cotizacion ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Observación</label>
                                                <textarea type="text" class="form-control input-sm" rows="2" id="psrad_observa" name="psrad_observa" ><?= $row->observacion ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                ...
                <div class="row">
                    <form id="form-detail" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Tarifa</label>
                                <input type="text" class="form-control input-sm det-required decimals" value="0" id="drad_tarifa"   />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Global</label>
                                <input type="text" class="form-control input-sm det-required decimals" value="0" id="drad_global"  />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Total</label>
                                <input readonly type="text" class="form-control input-sm det-required numerico"  id="drad_total"   />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
<script>
    ...
    function OpenDetail(id_detalle){
        $('#form-detail')[0].reset();
        $.post('<?= base_url() ?>Managerbudget/C_Ppto/GetRowDetailppto',{table:'det_radio',field:'drad_id',id_detalle:id_detalle},function(data){
            
            
            cargarPrograma(data.emis_id,'emis_id','cat_programasr',data.progr_id);
            
            $('#emis_id').val(data.emis_id);
            $('#unidad').val(data.unidad);
            $('#drad_ciudad').val(data.drad_ciudad);
            $('#drad_frecuencia').val(data.drad_frecuencia);
            $('#drad_fechaini').val(data.drad_fechaini);
            $('#drad_fechafin').val(data.drad_fechafin);
            $('#drad_seg').val(data.drad_seg);
            $('#drad_totalcuna').val(data.drad_totalcuna);
            $('#drad_dias').val(data.drad_dias);
            $('#drad_numcuna').val(data.drad_numcuna);
            $('#drad_detalle').val(data.drad_detalle);
            
            $('#drad_tarifa').autoNumeric('set', data.drad_tarifa);
            $('#drad_global').autoNumeric('set', data.drad_global);
            $('#drad_total').autoNumeric('set', data.drad_total);
