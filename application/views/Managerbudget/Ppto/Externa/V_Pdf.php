...
<html lang="en">
    ...
    <body>
        <header class="clearfix">
            ...
            <?php if($printOrder == 0): ?>
            <h1><b>PRESUPUESTO DE EXTERNA No. <?=$v->id?> <?=(count($bill)>0)?' FACTURA '.$bill->factura_id:''?></b></h1>
            <?php else: ?>
            <h1><b>ORDEN DE EXTERNA No. <?=$orden->ord_id?></b></h1>
            <?php endif; ?>
            <table id="head" >
                <tr>
            ...
            <table id="aviso" >
                ...
                <tbody>
                    <?php foreach ($detail as $d) : ?>
                        <tr>
                            <td class="desc" style="text-align:left; border-bottom: 1px solid #C1CED9;"><?=$d->dprode_detalle?></td>
                            <td class="unit" style=" border-bottom: 1px solid #C1CED9;">$<?=number_format($d->dprode_valor,0,"",".")?></td>
                        </tr>
                    <?php 
