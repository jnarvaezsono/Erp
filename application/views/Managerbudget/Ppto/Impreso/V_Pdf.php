...
<html lang="en">
    ...
    <body>
        <header class="clearfix">
            ...
            <?php if($printOrder == 0): ?>
            <h1><b>PRESUPUESTO DE IMPRESO No. <?=$v->id?> <?=(count($bill)>0)?' FACTURA '.$bill->factura_id:''?></b></h1>
            <?php else: ?>
            <h1><b>ORDEN DE IMPRESO No. <?=$orden->ord_id?></b></h1>
            <?php endif; ?>
            <table id="head" >
                <tr>
            ...
            <table id="aviso" >
                <tbody>
                    <?php foreach ($detail as $row) : ?>
                        <tr>
                            <td style="text-align:left;width:12.5%"><b>Elemento:</b></td><td style="text-align:left;width:12.5%" ><?=$row->elemento?></td>
                            <td style="text-align:left;width:12.5%"><b>Material:</b></td><td style="text-align:left;width:12.5%" ><?=$row->dimp_material?></td>
                            <td style="text-align:left;width:12.5%"><b>Tamaño:</b></td><td style="text-align:left;width:12.5%" ><?=$row->dimp_tamano?></td>
                            <td style="text-align:left;width:10%"><b>Cantidad:</b></td><td style="text-align:left;width:15%" ><?=number_format($row->dimp_cantidad,0,"",".")?></td>
                        </tr>
                        <tr>
                            <td style="text-align:left"><b>Tintas:</b></td><td style="text-align:left" ><?=$row->dimp_tintas?></td>
                            <td style="text-align:left"><b>Páginas:</b></td><td style="text-align:left" ><?=$row->dimp_pagina?></td>
                            <td style="text-align:left"><b>Acabados:</b></td><td style="text-align:left" ><?=$row->dimp_acabados?></td>
                            <td style="text-align:left"><b>Área Impresión:</b></td><td style="text-align:left"><?=$row->dimp_area_impresion?></td>
                        </tr>
                        <tr>
                            <td style="text-align:left"><b>Área Visual:</b></td><td style="text-align:left" ><?=$row->dimp_area_visual?></td>
                            <td style="text-align:left"><b>Concepto:</b></td><td style="text-align:left" ><?=$row->concepto?></td>
                            <td style="text-align:left"><b>Valor:</b></td><td style="text-align:left" >$ <?=number_format($row->dimp_valor,0,"",".")?></td>
                            <td style="text-align:left"><b>Total:</b></td><td style="text-align:left" >$ <?=number_format($row->dimp_total,0,"",".")?></td>
                        </tr>
                        <?php if(!empty($row->dimp_observacion)): ?>
                        <tr style="border-bottom: 1px solid #C1CED9;">
                            <th style="text-align:left"><b>DETALLE :</b></th><th style="text-align:left" colspan="7"><?=$row->dimp_observacion?></th>
                        </tr>
                        <?php else: ?>
                            <tr style="border-bottom: 1px solid #C1CED9;"><td colspan="8"></td></tr>
                        <?php endif; ?>
                    <?php 
