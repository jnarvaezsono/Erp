...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-edit"></i> Impreso N&deg;
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-sm decimals" id="imp_desc" name="imp_desc" value="<?= $row->descuento ?>" placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input type="text" class="form-control input-sm decimals" id="imp_iva" name="imp_iva" value="<?= $row->iva ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input type="text" class="form-control input-sm decimals" id="imp_spa" name="imp_spa" value="<?= $row->spa ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">%</span>
                                        <input readonly type="text" class="form-control input-sm decimals" id="imp_ivaspa" name="imp_ivaspa" value="<?= $row->iva_spa ?>"  placeholder="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon">$.</span>
                                        <input readonly type="text" class="form-control input-sm decimals" id="imp_valor" value="<?= $row->valor ?>" placeholder="$ 0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-sm" id="imp_numorden" name="imp_numorden" value="<?= $row->orden_cliente ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>No.Cotización</label>
                                                <input type="text" class="form-control input-sm" id="imp_numcotizacion" name="imp_numcotizacion" value="<?= $row->cotizacion ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Observación</label>
                                                <textarea type="text" class="form-control input-sm" rows="2" id="imp_observacion" name="imp_observacion" ><?= $row->observacion ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
...
<script>
    ...
    function OpenDetail(id_detalle){
        $('#form-detail')[0].reset();
        $.post('<?= base_url() ?>Managerbudget/C_Ppto/GetRowDetailppto',{table:'det_impresos',field:'dimp_id',id_detalle:id_detalle},function(data){
            
            $('#elemento_id').val(data.elemento_id);
            $('#unidad').val(data.unidad);
            $('#dimp_tamano').val(data.dimp_tamano);
            $('#dimp_material').val(data.dimp_material);
            $('#dimp_cantidad').val(data.dimp_cantidad);
            $('#dimp_pagina').val(data.dimp_pagina);
            $('#dimp_acabados').val(data.dimp_acabados);
            $('#dimp_area_impresion').val(data.dimp_area_impresion);
            $('#dimp_area_visual').val(data.dimp_area_visual);
            $('#dimp_observacion').val(data.dimp_observacion);
            $('#dimp_tintas').val(data.dimp_tintas);
            $('#dimp_distribucion').val(data.dimp_distribucion);
            $('#dimp_gramaje').val(data.dimp_gramaje);
            $('#concp_id').val(data.concp_id);
            
            $('#dimp_valor').autoNumeric('set', data.dimp_valor);
            $('#dimp_total').autoNumeric('set', data.dimp_total);
    ...
    function UpdateDetail(id_detalle){
        if (validatefield('det-required')) {
            ...
            var formData = new FormData($('#form-detail')[0]);
            formData.append("dimp_id", id_detalle);
            formData.append("imp_id", <?= $id ?>);
            formData.append("tipo", <?= $tipo ?>);
            formData.append("dimp_valor", $('#dimp_valor').val().replace(/\./g, '').replace(/,/g, '.'));
            formData.append("dimp_total", $('#dimp_total').val().replace(/\./g, '').replace(/,/g, '.'));
