...
<html lang="en">
    ...
    <body>
        <header class="clearfix">
            ...
            <?php if($printOrder == 0): ?>
            <h1><b>PRESUPUESTO DE PUBICIDAD EXTERIOR No. <?=$v->id?> <?=(count($bill)>0)?' FACTURA '.$bill->factura_id:''?></b></h1>
            <?php else: ?>
            <h1><b>ORDEN DE PUBICIDAD EXTERIOR No. <?=$orden->ord_id?></b></h1>
            <?php endif; ?>
            <table id="head" >
                <tr>
            ...
            <table id="aviso" >
                <tbody>
                    <?php foreach ($detail as $row) : ?>
                        <tr>
                            <td style="text-align:left;width:12.5%"><b>Fecha Inicio :</b></td><td style="text-align:left;width:12.5%" ><?=$row->dpubext_fechainicio?></td>
                            <td style="text-align:left;width:12.5%"><b>Fecha Fin :</b></td><td style="text-align:left;width:12.5%" ><?=$row->dpubext_fechafin?></td>
                            <td style="text-align:left;width:12.5%"><b>Duración :</b></td><td style="text-align:left;width:12.5%" ><?=$row->dpubext_duracion?></td>
                            <td style="text-align:left;width:10%"><b>Pieza :</b></td><td style="text-align:left;width:15%" ><?=$row->pieza?></td>
                        </tr>
                        <tr>
                            <td style="text-align:left"><b>Ciudad:</b></td><td style="text-align:left" ><?=$row->dpubext_ciudad?></td>
                            <td style="text-align:left"><b>Tamaño Impresión:</b></td><td style="text-align:left" ><?=$row->dpubext_tamimpresion?></td>
                            <td style="text-align:left"><b>Area Visual:</b></td><td style="text-align:left" ><?=$row->dpubext_areavisual?></td>
                            <td style="text-align:left"><b>Ubicación:</b></td><td style="text-align:left" rowspan="2"><?=$row->dpubext_ubicacion?></td>
                        </tr>
                        <tr>
                            <td style="text-align:left"><b>Valor Unitario:</b></td><td style="text-align:left" ><?=number_format($row->dpubext_vlruni,0,"",".")?></td>
                            <td style="text-align:left"><b>Cantidad:</b></td><td style="text-align:left" ><?=$row->dpubext_cantidad?></td>
                            <td style="text-align:left"><b>Total:</b></td><td style="text-align:left" >$ <?=number_format($row->dpubext_total,0,"",".")?></td>
                        </tr>
                        <?php if(!empty($row->dpubext_detalle)): ?>
                        <tr style="border-bottom: 1px solid #C1CED9;">
                            <th style="text-align:left"><b>DETALLE :</b></th><th style="text-align:left" colspan="7"><?=$row->dpubext_detalle?></th>
                        </tr>
                        <?php else: ?>
