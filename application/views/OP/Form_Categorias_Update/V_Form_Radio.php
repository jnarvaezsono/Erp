    ...
    <div class="form-group">
        ...
        <select class="form-control   input-task select-modal-form " id="t_emisora" name="id_emisora" onchange="LoadSelect('t_programa', this.value)">
            ...
            <?php foreach ($emisoras as $v) : ?>
                <option value="<?= $v->emis_id ?>" <?= ($info->id_emisora == $v->emis_id) ? "selected" : "" ?>><?= $v->emis_nombre ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
    ...
    <div class="form-group">
        ...
        <select class="form-control   input-task select-modal-form " id="t_programa" name="id_programa" >
            ...
            <?php foreach ($programas as $v) : ?>
                <option value="<?= $v->progr_id ?>" <?= ($info->id_programa == $v->progr_id) ? "selected" : "" ?>><?= $v->progr_nombre ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <div class="input-group date">
            ...
            <input type="text" id="t_fecha_inicio" name="fecha_inicio" value="<?= $info->fecha_inicio ?>" class="form-control pull-right input-task  picker-task " >
        </div>
    </div>
</div>
<div class="col-md-3">
    <div class="form-group">
        ...
        <div class="input-group date">
            ...
            <input type="text" id="t_fecha_fin" name="fecha_fin" value="<?= $info->fecha_fin ?>" class="form-control pull-right input-task  picker-task" >
        </div>
    </div>
</div>
<div class="col-md-3">
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="number" class="form-control " id="t_dias" name="dias" value="<?= $info->dias ?>">
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
