<div class="modal fade" id="modal-cot">
    <div class="modal-dialog" style="width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-fw fa-tasks"></i> Adjuntar Cotizacion</h4>
            </div>
            <div class="modal-body">
                <div class="tab-pane" id="tab_2">
                    <form class="fileupload"  id="upload_cotizacion" method="POST" enctype="multipart/form-data">
                        ...
                        <table role="presentation" id="table-adjuntos-cot" class="table table-striped"><tbody class="files"></tbody></table>
                    </form>
                </div>
            </div>
...
<script id="template-upload-cot" type="text/x-tmpl">
...
<script id="template-download-cot" type="text/x-tmpl">
    {% for (var i=0, file; file=o.files[i]; i++) { %}
